...
export class Backend implements backendInterface {
    ...
    async getScores(): Promise<GameResult> {
    ...
    async recordGameResult(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordGameResult(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetScores(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
